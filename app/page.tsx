...
function TrustBar() {
  ...
  return (
    <div className="trust-bar">
      {items.map((item) => (
        <span key={item} className="mono" style={{ color: "var(--muted)", fontSize: "9px", letterSpacing: "0.2em", whiteSpace: "nowrap" }}>
          {item}
        </span>
      ))}
    </div>
    ...
    <section id="demo" className="section-wrap" aria-labelledby="demo-heading">
      ...
      <div className="two-col">
        <div className="two-col-label">
          <span className="section-label reveal">Live demo</span>

          <div className="live-badge reveal reveal-delay-1" style={{ marginTop: "1rem", width: "fit-content" }}>
            <span className="status-dot" />
            Available now
          </div>

          <div className="demo-stats reveal reveal-delay-2">
            {([
        ...
        <div className="two-col-content">
          <h2 id="demo-heading" className="section-title reveal">
            Talk to the<br />
            <em>receptionist</em>
          </h2>
          <p className="section-body reveal reveal-delay-1" style={{ marginBottom: "clamp(2rem, 4vw, 3rem)" }}>
            Click below. The AI agent picks up instantly and converses in Hindi
            or English — live, in your browser. No app, no install.
          </p>

          <div className="call-box reveal reveal-delay-2">
            <CallWidget />
          </div>
    ...
    <section className="section-wrap" style={{ paddingTop: 0 }}>
      <div className="cta-banner">
        <div style={{ position: "relative", zIndex: 1 }}>
          <span className="section-label reveal" style={{ marginBottom: "1.5rem" }}>
            Get started
          </span>
          <h2 className="section-title reveal reveal-delay-1" style={{
            maxWidth: "20ch",
          ...
          <p className="section-body reveal reveal-delay-2" style={{ marginBottom: "2.5rem", marginTop: "0.5rem" }}>
          ...
          <div className="reveal reveal-delay-4" style={{
            marginTop: "2.5rem", display: "flex", gap: "2rem", flexWrap: "wrap",
          }}>
            {["No credit card", "48 hr setup", "Cancel anytime"].map((t) => (
              <span key={t} className="mono" style={{ fontSize: "8.5px", color: "var(--muted)", letterSpacing: "0.18em" }}>
                ✓ {t}
              </span>
            ))}
          </div>
